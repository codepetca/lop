...
const adjectives = [
	'Swift', 'Bright', 'Clever', 'Bold', 'Quick', 'Wise', 'Calm', 'Sharp',
	'Brave', 'Gentle', 'Fierce', 'Noble', 'Strong', 'Silent', 'Mighty',
	'Glowing', 'Hidden', 'Dancing', 'Soaring', 'Blazing', 'Crystal', 'Golden',
	'Silver', 'Starlit', 'Mystic', 'Shadow', 'Thunder', 'Lightning', 'Crimson',
	'Azure', 'Emerald', 'Cosmic', 'Wild', 'Free', 'Ancient', 'Radiant'
];

const nouns = [
	'Panda', 'Wolf', 'Eagle', 'Tiger', 'Fox', 'Bear', 'Lion', 'Hawk',
	'Dragon', 'Phoenix', 'Falcon', 'Raven', 'Owl', 'Lynx', 'Jaguar',
	'Moon', 'Star', 'Sun', 'Storm', 'Wind', 'Fire', 'Ocean', 'Mountain',
	'River', 'Forest', 'Crystal', 'Flame', 'Arrow', 'Blade', 'Shield',
	'Crown', 'Gem', 'Pearl', 'Comet', 'Nova', 'Quest', 'Spirit'
];
